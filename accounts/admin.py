...
class CustomUserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('full_name', 'short_name', 'email','department', 'location', 'contact_no')}),
    ...
    list_display = ('username', 'email', 'full_name', 'department', 'contact_no', 'location', 'short_name', 'is_staff')
    list_filter = ('is_staff', 'is_superuser', 'is_active', 'groups')
    search_fields = ('username', 'full_name', 'short_name', 'email', 'department', 'contact_no')
    ordering = ('username',)
